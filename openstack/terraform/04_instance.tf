...
resource "openstack_compute_instance_v2" "openvpn" {
  ...
  depends_on = [openstack_networking_subnet_v2.network_subnet, openstack_networking_secgroup_rule_v2.secgroup_openvpn_rule_v4, openstack_networking_secgroup_rule_v2.secgroup_openvpn_rule_udp_v4]
}
