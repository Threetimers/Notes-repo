...
user1 = input ("enter the username for the ssh connection: ")

router1 = {'server_ip':'192.168.122.10', 'server_port': '22', 'user': user1, 'passwd': 'cisco'}
router2 = {'server_ip':'192.168.122.20', 'server_port': '22', 'user': user1, 'passwd': 'cisco'}
router3 = {'server_ip':'192.168.122.30', 'server_port': '22', 'user': user1, 'passwd': 'cisco'}
